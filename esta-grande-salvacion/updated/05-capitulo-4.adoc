...
Esto evidentemente implica que Su Espíritu sí contendió con el hombre,
y aún contiende con el hombre por un tiempo,
...
Porque primero,
Él da a entender que hubo un día en que los habitantes de
...
+++[+++es decir, por la Luz].^
footnote:[Nota de Barclay: di`' autou (por él,
o por medio de él) concuerda muy bien con photos (la Luz),
...
Así que esta cláusula relativa di`' autou debe necesariamente referirse a la Luz (photos),
...
insistían que esta es una medida o don insuficiente para salvar el alma.
...
"`lo que se conoce acerca de Dios es evidente dentro de ellos`" y es en y por esto que
...
footnote:[Lib.
2, Stromat.]
El mismo autor, en su Advertencia a los Gentiles,
...
La tercera proposición que necesita probarse tiene dos partes: Primero,
...
y segundo, que por la obra y operación de esta misma Gracia y Luz,
...
I+++.+++ En cuanto a lo primero, debido a que la mayoría ya lo reconoce,
...
II. En segundo lugar, lo que ahora falta por probar es lo siguiente:
...
concederse la misma caridad a los que son capaces de comprender,
...
y conozcan a Cristo en ellos, a quien Santiago llama "`el Justo +++[+++ton Dikaion],
